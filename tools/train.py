...
def parse_config():
    ...
    parser.add_argument('--dont_evaluate', action='store_true', default=False, help='dont perform evaluation')
...
def main():
    ...
    if args.dont_evaluate == False:
        ...
        eval_output_dir = output_dir / 'eval' / 'eval_all_default' / 'default'
        eval_output_dir.mkdir(parents=True, exist_ok=True)
        args.start_epoch = 70  # Only evaluate the last 10 epochs
